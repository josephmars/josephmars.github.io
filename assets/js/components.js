...
function createFooter() {
    ...
    <footer class="d-flex flex-wrap justify-content-center py-3 my-4 border-top">
        <div class="d-flex justify-content-center gap-3 mt-3">
            ...
            <a href="https://scholar.google.com/citations?user=Ho8bdnAAAAAJ&hl=en" class="text-body" target="_blank">
                <i class="fa-brands fa-google-scholar" style="font-size: 1.5em; color: currentColor;"></i>
            </a>
